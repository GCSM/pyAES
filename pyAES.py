...
class AES(object):
  ...
  0x61, 0xc2, 0x9f, 0x25, 0x4a, 0x94, 0x33, 0x66, 0xcc, 0x83, 0x1d, 0x3a, 0x74, 0xe8, 0xcb]
    ...
    def keyexpansion(self):
        ...
        for i in range(0, self.aes_wordskey, 1):
        ...
        for i in range(i, (i <(self.aes_nb * (self.aes_nr + 1))), 1):
            for j in range(0, 4, 1):
                self.tempa[j]=self.RoundKey[(i-1) * 4 +j]
            if (i % self.aes_nk == 0):
                #Rotate bytes to the left
                self.k = self.tempa[0]
                self.tempa[0] = self.tempa[1]
                self.tempa[1] = self.tempa[2]
                self.tempa[2] = self.tempa[3]
                self.tempa[3] = self.k
